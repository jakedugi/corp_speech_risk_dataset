...
def main():
    ...
    parser.add_argument("--db-root", type=Path, default=None, help="Source root for .txt files (overrides config.DB_DIR)")
    parser.add_argument("--mirror-out", type=Path, default=None, help="Destination root for mirrored output (overrides config.MIRROR_OUT_DIR)")
