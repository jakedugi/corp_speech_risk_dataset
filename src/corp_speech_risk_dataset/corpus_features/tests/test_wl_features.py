...
def test_wl_vector_different():
    ...
    test_pairs = [
        ...
        ("Corporate governance requirements.", "Corporate finance regulations."),
        ("SEC Form 10-K filing.", "SEC Form 8-K report."),
    ]
...
def test_wl_vector_similarity():
    ...
    similar_pairs = [
        ("The company filed SEC Form 10-K.", "The company submitted SEC Form 10-K."),
        (
    ...
    different_pairs = [
        ("The company filed SEC Form 10-K.", "Revenue increased by 15% this quarter."),
        (
            "Board approved the governance policy.",
