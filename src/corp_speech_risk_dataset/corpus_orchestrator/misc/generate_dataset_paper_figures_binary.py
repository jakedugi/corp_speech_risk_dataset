...
def analyze_dataset(file_path: str, kfold_dir: Path | None = None) -> dict:
    ...
    if kfold_dir and (kfold_dir / "per_fold_metadata.json").exists():
        ...
        # Use fold 4 (final training fold) boundary for display and inheritance
        print(
            f"Available folds: {list(per_fold_metadata['binning']['fold_edges'].keys())}"
        )
...
def main():
    ...
    # Configuration - Updated for binary classification
